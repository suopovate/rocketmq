...
/**
 * All the requests from clients,will be forwarded to the broker local or remote.
 * And we can do something check or authentication before we call the real processor.
 */
