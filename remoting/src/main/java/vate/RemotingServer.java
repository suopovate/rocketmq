 ...
 * @author 曾碹
 */
public interface RemotingServer<C> extends RemotingService {
    ...
    RemotingCommand invokeSync(
        final C channel, final RemotingCommand request,
        final long timeoutMillis
    ) throws InterruptedException, RemotingSendRequestException,
             RemotingTimeoutException;

    void invokeAsync(
        final C channel, final RemotingCommand request, final long timeoutMillis,
